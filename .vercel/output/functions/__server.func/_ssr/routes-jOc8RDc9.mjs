...
import { t as van_default } from "./van-h1Z1TFYH.mjs";
import { n as require_jsx_runtime, r as require_react } from "../_libs/react+tanstack__react-query.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-B1M7aTFd.mjs";
import { i as TSS_SERVER_FUNCTION, l as createServerFn } from "./esm-Dova13aH.mjs";
import { n as enquirySchema, t as GUEST_LABELS } from "./enquiry-schema-BmC8LSgX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-jOc8RDc9.js
...
var sendEnquiry = createServerFn({ method: "POST" }).validator((data) => enquirySchema.parse(data)).handler(createSsrRpc("d7c58d83ea5d9fb6ea14bbee48208b480c0f3465375db0b0b9290487c4b7f00a"));
var treats = [
	{
		name: "Classic Cone",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "hidden md:flex gap-8 text-sm font-semibold uppercase tracking-widest",
						children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: treats.map((treat, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
									className: "font-display text-5xl md:text-7xl uppercase text-secondary mb-4 leading-tight",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
				className: "bg-foreground text-background py-20 px-6",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
